...
public class modul3_Activity extends AppCompatActivity {
    //inisialisasi widget
    private EditText edit_nama, edit_nim,edit_tgl,edit_hobi;
    ...
    String [] ArrayKota = {"Madiun","Bandung","Bogor","Bangkalan",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(modul3_Activity.this,modul3_isi_Activity.class);
